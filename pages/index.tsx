    ...
    return (
        <div className="overflow-auto flex flex-col">
            ...
            <main className="container mx-auto px-16 flex-grow">
                ...
                <div className="bg-blue-100 border-blue-200 border px-4 py-3 rounded">
                ...
                <div className="flex flex-wrap justify-start md:justify-between items-center my-10">
                    <div className="w-72 mb-2">
                        ...
                        <h4 className="text-purple mt-5 mb-2">Quick Start</h4>
                ...
                <div>
                    ...
                    <div className="flex flex-wrap justify-start md: justify-between items-center my-10">
                        <div className="w-72 mb-2">
                            ...
                            <h4 className="text-purple mt-5 mb-2">Schema</h4>
                            <p className="text-sm">
                                Welcome to the dotCMS documentation site. This site contains the
                                documentation for the latest dotCMS release
                            </p>
