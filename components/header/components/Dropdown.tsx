...
const Dropdown = (): JSX.Element => {
    ...
    return (
        <div className="cursor-pointer relative">
            <div
                className="flex items-center content-center justify-between select-none bg-white rounded w-40 h-8 text-xs border border-secondary text-gray px-2 pr-43"
            ...
            >
                ...
                <i className="relative -top-0.5	border-2 border-gray border-t-0 border-l-0 p-1 inline-block transform rotate-45" />
            </div>
            <div
